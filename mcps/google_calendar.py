...
def google_calendar_server() -> MCPServerStdio:
    """Return a configured MCPServerStdio for Google Calendar.
    ...
    In Stage 1c, this is passed to Agent(mcp_servers=[google_calendar_server()])
...
# def google_calendar_server() -> MCPToolset:
#     """Return a configured MCPServerStdio for Google Calendar.
