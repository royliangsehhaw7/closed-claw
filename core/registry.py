...
class AgentRegistry:
    ...
    # _cached_specialists: Dict[Tuple[str, str], Any]  # Maps (agent_key, user_email) -> instance
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            # Initialize both metadata tracking and live object caching
            # cls._instance._agents = {}
            # cls._instance._cached_specialists = {}
    ...
    def load_from_disk(self, skills_dir: str = "skills") -> None:
        ...
        # self._agents.clear()
        # self._cached_specialists.clear()  # Wipe instance cache on disk reload
    ...
    def build_specialist(self, key: str, user_email: str) -> SpecialistProtocol:
        """Retrieves a cached instance or builds a specialist agent engine using the user_email."""
        # Create a unique composite cache key combining the agent identifier and user context
        # cache_key = (key, user_email)
        # # 1. Cache Hit Check
        # if cache_key in self._cached_specialists:
        #     return self._cached_specialists[cache_key]
        ...
        # # 3. Instantiation preserving user_email exactly as before
        # instance = agent_cls(key=key, registration=registration, user_email=user_email)
        
        # # 4. Save to Cache
        # self._cached_specialists[cache_key] = instance
        # return instance
